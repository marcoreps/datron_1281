...
instruments["J1281"]=rm.open_resource("TCPIP::192.168.0.88::GPIB0,16")
...
instruments["F5700A"]=rm.open_resource("TCPIP::192.168.0.88::GPIB0,1")
...
with open('csv/'+timestr+'REPS5700A_3458A_J1281_INL.csv', mode='w') as csv_file:
    ...
    fieldnames = ['vref', '3458A_volt', 'J1281_volt']
    ...
    for u in numpy.arange(umin, umax+0.01, ustep):
        ...
        writer.writerow({'vref': calibrator_out, '3458A_volt': HP3458A_out, 'J1281_volt': J1281_out})